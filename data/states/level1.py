...
class Level1(tools._State):
    ...
    def startup(self, current_time, persist):
        ...
        self.setup_enemies()
        self.setup_mario()
        self.setup_checkpoints()  # si se comenta esta linea no spawnean enemigos
    ...
    def play_death_song(self):
        ...
        elif (self.current_time - self.death_timer) > 10: #change this number for death animation time
